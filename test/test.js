(function () {
    ...
    e.prototype.focus = function (e) {
        var t;
        if (r && e.setSelectionRange && e.type.indexOf("date") !== 0 && e.type !== "time" && e.type !== "month" && e.type !== "email") {
            t = e.value.length;
            e.focus();
    ...
    e.prototype.onTouchStart = function (e) {
        ...
        this.trackingClickStart = a;
        this.targetElement = t;
        this.touchStartX = n.pageX;
        this.touchStartY = n.pageY;
        if (a - this.lastClickTime < this.tapDelay) {
            e.preventDefault()
        }
        return true
    };
    ...
    e.prototype.onTouchEnd = function (e) {
        var t, a, s, u, c, l = Date.now(),
            f = this.targetElement;
        if (!this.trackingClick) {
            return true
        }
        if (l - this.lastClickTime < this.tapDelay) {
            this.cancelNextClick = true;
            return true
        }
        if (l - this.trackingClickStart > this.tapTimeout) {
            return true
        }
        ...
        if (o) {
            ...
            f = document.elementFromPoint(c.pageX - window.pageXOffset, c.pageY - window.pageYOffset) || f;
            f.fastClickScrollParent = this.targetElement.fastClickScrollParent
        }
        s = f.tagName.toLowerCase();
        if (s === "label") {
            t = this.findControl(f);
            if (t) {
                this.focus(f);
                if (n) {
                    return false
            ...
            if (l - a > 100 || r && window.top !== window && s === "input") {
                this.targetElement = null;
                return false
            }
            this.focus(f);
